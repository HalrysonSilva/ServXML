...
type
  TDatamodule1 = class(TDataModule)
    ...
    QRYEMITENTE: TUniQuery;
    DSQRYEMITENTE: TDataSource;
    QRYBUSCAXML: TUniQuery;
    DSQRYBUSCAXML: TDataSource;
    QRYTIPONOTA: TUniQuery;
    QRYEMAILLOG: TUniQuery;
    QRYSERIE: TUniQuery;
    QRYCRIATABSERVXML: TUniQuery;
    QRYINSERESERVXML: TUniQuery;
    QRYVERIFICASERVXML: TUniQuery;
    QRYBUSCARVALOR: TUniQuery;
    QRYBUSCARNOTAS: TUniQuery;
    DSQRYBUSCARNOTAS: TDataSource;
    QRYADDTAREFA: TUniQuery;
    QRYSALVAARQXML: TUniQuery;
    QRYVERIFICAINUTILIZACAO: TUniQuery;
    QRYVERIFICANFE_XML: TUniQuery;
    QRYBUSCANTSALVARNFE_XML: TUniQuery;
    QRYBUSCANTSALVARSERVXML: TUniQuery;
    QRYTOTALEMITIDO: TUniQuery;
    QRYBUSCARSALVADORES: TUniQuery;
    QRYXMLNFeInutilizada: TUniQuery;
    QRYXMLNFeCab: TUniQuery;
    QRYXMLNFCeCab: TUniQuery;
    QRYXMLCanceladas: TUniQuery;
    QRYNOTASRECEBIDAS: TUniQuery;
    DsQRYNOTASRECEBIDAS: TDataSource;
    QRYNOTAPERDIDA: TUniQuery;
    DSQRYNOTAPERDIDA: TDataSource;
    QRYCORRIGEDADOS: TUniQuery;
    QRYVENDASPENDENTES: TUniQuery;
    DSVENDASPENDENTES: TDataSource;
    QRYLIMPANFCE: TUniQuery;
    QRYBUSCAULTIMANFCE: TUniQuery;
    QRYNOVONUMNFCEMANUAL: TUniQuery;
    DSSequencia: TDataSource;
    QRYSequencia: TUniQuery;
    QRYupdatebanco: TUniQuery;
    frxReportNotas: TfrxReport;
    frxdsNotas: TfrxDBDataset;
    QRYVERITABEST3A: TUniQuery;
    QRYPSQPENDENTE: TUniQuery;
    QRYTOTALPENDENTE: TUniQuery;
    DSQRYPSQPENDENTE: TDataSource;
    DSQRYTOTALPENDENTE: TDataSource;
    QRYSALVAENVIO: TUniQuery;
    QRYDELETENFEINUT: TUniQuery;
    CDSCONSULTACHAVE: TClientDataSet;
    QRYNUMNOTASEFAZ: TUniQuery;
    DSCDSCONSULTACHAVE: TDataSource;
    QRYCORRIGEPENDENCIA: TUniQuery;
    QRYCARREGAVENDAS: TUniQuery;
    DSQRYCARREGAVENDAS: TDataSource;
    QRYMIGRAR_XMLTEMP: TUniQuery;
    QRYCHAVEDIFERENTE: TUniQuery;
    QRYATUALIZACHAVE: TUniQuery;
    DSCDSCHAVESCORRETAS: TDataSource;
    CDSCHAVESCORRETAS: TClientDataSet;
    CDSCHAVESCORRETASCODNOTA: TIntegerField;
    CDSCHAVESCORRETASANTIGACHAVE: TStringField;
    CDSCHAVESCORRETASNOVACHAVE: TStringField;
    CDSCHAVESCORRETASCODEMITENTE: TIntegerField;
    CDSCHAVESCORRETASNUMNOTA: TStringField;
    CDSCHAVESCORRETASserie: TStringField;
    QRYNAOUSADOSPORDATA: TUniQuery;
    QRYBUSCAXMLcodnota: TIntegerField;
    QRYBUSCAXMLcodemitente: TIntegerField;
    QRYBUSCAXMLdata_emissao: TDateTimeField;
    QRYBUSCAXMLNum_Nota_Fiscal: TIntegerField;
    QRYBUSCAXMLSerie: TStringField;
    QRYBUSCAXMLpedido: TIntegerField;
    QRYBUSCAXMLstatus: TStringField;
    QRYBUSCAXMLxmlchave: TStringField;
    QRYBUSCAXMLValor: TFloatField;
    QRYBUSCAXMLTipo_Amb: TIntegerField;
    QRYBUSCAXMLNum_Mod_Doc: TIntegerField;
